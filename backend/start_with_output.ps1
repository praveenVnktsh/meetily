...
if (-not (Test-Path "whisper-server-package\whisper-server.exe")) {
    ...
    try {
        ...
        $apiUrl = "https://api.github.com/repos/praveenvnktsh/minutes/releases/latest"
        ...
        $downloadUrl = "https://github.com/praveenvnktsh/minutes/releases/download/$tagName/whisper-server.exe"
        ...
        try {
            $allReleasesUrl = "https://api.github.com/repos/praveenvnktsh/minutes/releases"
            $headers = @{"User-Agent" = "PowerShell-Script"}
            ...
            if ($releases.Count -gt 0) {
                ...
                $altDownloadUrl = "https://github.com/praveenvnktsh/minutes/releases/download/$latestTag/whisper-server.exe"
            ...
            Write-Host "https://github.com/praveenvnktsh/minutes/releases"
