...
///
/// Maps template identifiers to their embedded JSON content. Currently exercised
/// by the template tests and kept alongside the other built-in template helpers.
#[allow(dead_code)]
