  ...
  const handleBrowse = async () => {
    try {
      ...
      if (dbPath) {
        ...
        setErrorMessage('No database found at selected location. Please select the Minutes folder, backend folder, or the database file directly.');
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[600px]" onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Minutes!</DialogTitle>
          <DialogDescription className="text-base pt-2">
            Do you have data from a previous Minutes installation?
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <p className="text-sm text-ink-muted">
              Select your previous Minutes folder, backend directory, or database file:
            </p>
          ...
          <div className="flex flex-col gap-3 pt-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-surface-2 disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-surface-raised text-ink-muted">or</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-hairline text-ink rounded-lg hover:bg-surface-2 disabled:bg-surface-2 disabled:cursor-not-allowed transition-colors"
            >
