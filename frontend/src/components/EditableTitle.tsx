...
export const EditableTitle: React.FC<EditableTitleProps> = ({
  ...
  return isEditing ? (
    ...
    <div className="group flex items-center space-x-2 flex-1">
      <h1
        className="text-2xl font-bold cursor-pointer hover:bg-surface-2 rounded px-1 flex-1 whitespace-pre-wrap"
      ...
      <div className="flex space-x-1">
        <button 
          onClick={onStartEditing}
          className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-1 hover:bg-surface-2 rounded"
