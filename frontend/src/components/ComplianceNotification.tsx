...
export const ComplianceNotification: React.FC<ComplianceNotificationProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-surface-raised border border-hairline rounded-lg shadow-lg p-3">
        ...
        <div className="flex items-start justify-between mb-2">
          ...
          <button
            onClick={handleClose}
            className="text-ink-subtle hover:text-ink-muted transition-colors p-0.5 rounded hover:bg-surface-2"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
