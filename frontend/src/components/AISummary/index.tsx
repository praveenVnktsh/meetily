...
export const AISummary = ({ summary, status, error, onSummaryChange, onRegenerateSummary, meeting }: Props) => {
  ...
  if (!hasContent && status === 'completed') {
    return (
      <div className="w-full p-4 bg-surface-2 border border-hairline rounded-lg text-center">
  ...
  return (
    <div className="relative">
      ...
      {contextMenu.visible && selectedBlocks.length > 0 && (
        <div
          className="fixed z-50 bg-surface-raised shadow-lg rounded-lg py-1 min-w-[160px] border border-hairline
        ...
        >
          <button
            className="w-full px-4 py-2 text-left hover:bg-surface-2 flex items-center space-x-2"
      ...
      {/* <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="p-2 hover:bg-surface-2 rounded disabled:opacity-50"
            title="Undo"
          >
            <svg
          ...
          <button
            ...
            className="px-2 py-1 text-sm bg-surface-2 hover:bg-surface-2 rounded-md flex items-center space-x-1"
          >
            <span>📋</span>
            <span>Copy</span>
          </button>
