    ...
    return (
      <div className="p-4 space-y-4">
        <div className="animate-pulse">
          ...
          <div className="h-10 bg-surface-2 rounded mb-3"></div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="h-8 w-8 p-0 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-surface-2 disabled:pointer-events-none disabled:opacity-50"
          >
