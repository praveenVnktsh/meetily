            ...
            {showNavigation && (
              <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between pointer-events-none">
                <button
                  ...
                  className={cn(
                    'pointer-events-auto w-8 h-8 rounded-full bg-surface-raised border border-hairline shadow-sm flex items-center justify-center transition-all duration-200',
                    canGoPrevious && step !== 1
                      ? 'hover:bg-surface-2 hover:shadow-md hover:scale-110 text-ink'
